...
# 修改文件存储路径为当前目录下的data文件夹
USERS_FILE = os.path.join(os.path.dirname(__file__), 'data', 'users.xlsx')
ACCOUNTS_FILE = os.path.join(os.path.dirname(__file__), 'data', 'accounts.xlsx')
LOGS_FILE = os.path.join(os.path.dirname(__file__), 'data', 'logs.xlsx')
